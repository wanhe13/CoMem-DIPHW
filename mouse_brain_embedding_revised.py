...
seq_data_name = 'mouse_brain'

file_suffix = '_revised'

mouse_brain = pd.read_csv('data/GSE60361_C1-3005-Expression.txt', delimiter='\t', index_col=0)
print("Any NA values:", mouse_brain.isna().any().any())

counts = mouse_brain.copy()
...
# print('total reads by cell', print(np.sum(data_normalized_by_cells, axis=0)))
# print('total reads by gene', print(np.sum(data_normalized_by_cells, axis=1)))
